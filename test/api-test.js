 ...
 */
function doneAndDeregister(agent, done) {
  return function (err) {
    ...
    login(function (err, agent, player) {
      ...
      agent
        ...
        .end(function (err) {
          ...
          login(player.name, function (err, agent2) {
            if (err) return done(err);
            ...
            agent2
              ...
              .end(function (err) {
                ...
                agent
                  .get('/api/player')
                  .expect(401, doneAndDeregister(agent2, done));
              });
          });
        });
    });
